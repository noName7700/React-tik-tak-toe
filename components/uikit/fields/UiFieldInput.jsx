export function UiFieldInput({ required, errorText, inputProps }) {
    return (
        <input 
            ...
            id="example2" 
            required={required} 
            className={`px-2 py-2 leading-tight outline-0 border block w-full rounded-md shadow-sm 
            focus:ring-opacity-50 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 
            ${errorText ? "focus:border-orange-600 focus:ring focus:ring-orange-600/20 border-orange-600" 
