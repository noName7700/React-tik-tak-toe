...
export function useGameState(playersCount) {
    ...
    const handleCellClick = (index) => {
        setGameState((lastGameState) => {
            ...
            return {
                ...
                cells: lastGameState.cells.map((cell, idx) => idx === index ? lastGameState.currentMove : cell)
            }
        });
    }
    ...
    return {cells, currentMove, nextMove, handleCellClick, handlePlayerTimeOver, winnerSequence, winnerSymbol};
}